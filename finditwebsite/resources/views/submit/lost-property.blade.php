...
<input name="property_type" type="hidden" value="1">
...
<div class="row">
        <div class="col-sm-7 col-sm-push-5">
            <div class="lostfound_image"><img src="../public/assets/images/submit_lost_property.jpg" class="img-responsive"></div>
        </div>        
        ...
        <div class="lostfound_text">
            ...
            <div class="feature-list">
                <ul>
                    ...
                    <li>Extended Reach Out with Local Networks</li>
                </ul>
            </div>
            <div class="submit-btn">
                <a class="submit-found slide-down-btn" href="lost-property.html">Submit Lost Item</a>
            </div>
            <p><span class="required">*</span>Please be descriptive when submitting your lost property report, the more information you give us the better chance you have of retrieving your items.</p>
        </div>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group search-frm ">
                        <label for="sub_category_id" class="control-label lbl-descriptive">Item Lost
                            <small class="required">*</small>
                            <span class="label-detail">(Dog, Jacket, Smartphone, Wallet, etc.) This field may auto-populate</span>
                        </label>

                        <input id="search_sub_cat" class="form-control search-item-input" placeholder="Item Lost" name="sub_category_id" type="text">
                    ...
                    <div class="form-group search-frm ">
                        <label for="category_id" class="control-label lbl-descriptive">Category
                            <small class="required">*</small>
                            <span class="label-detail">(Animals/Pets, Clothing, Electronics, Personal Accessories etc.) This field is required.</span>
                        </label>
                    ...
                    <div class="form-group primary_color_div search-frm">
                        <label for="primary_color" class="control-label lbl-descriptive">Primary Color
                            <span class="label-detail">Please add the color that best represents the lost property (Black, Red, Blue, etc.)</span> 
                        </label>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                            <input id="incident_date" class="form-control" data-date-format="dd-mm-yyyy" placeholder="Date Lost" name="incident_date" type="text">
                    ...
                    <div class="form-group">
                        <label for="time" class="control-label lbl-descriptive">Time Lost
                            <small class="required">*</small>
                            <span class="label-detail">Please add the approximate time of day the item was lost.</span>
                        </label>

                        <div class="input-group">
                            <input id="time" class="form-control time" placeholder="Time Lost" name="time" type="text">
                            <span class="input-group-addon">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="where_type" class="control-label lbl-descriptive">Where Lost
                            <small class="required">*</small>
                            <span class="label-detail">Please provide an approximate location of the lost property (Bar, Restaurant, Park, etc.)</span>
                        </label>
...
<script>
    ...
    var loadPic = false;
        var cropPicOptions = {
            /*customUploadButtonId: 'upload_btn',*/
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input id="email" class="form-control" placeholder="Email" name="users[email]" type="email">
                                    </div>
            </div>
        </div>
    </div>
        ...
        <div class="property-form-body">
            <!-- <div class="row">
                <div class="col-sm-12">
                    <div class="pull-right">
                        <button type="button" class="btn btn-primary btn-lg btn-fs-16 pull-right" onclick="window.lostings.submitForm(this);">Submit</button>
                        <div class="text-right feature_chk">
                            <p>
                                <label class="checkbox style-checkbox lg feature_item_lbl text-right">
                                    <input type="hidden" name="feature_item" value="0">
                                    <input id="feature_item" name="feature_item" type="checkbox" value="1">
                                    Feature Item
                            ...
                            <span class="label-detail">Enhances Visibility Across Our Networks<span>
                        </div>
                    </div>
                </div>
            </div> -->
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="text-right feature_chk">
                            <p>
                                <label class="checkbox style-checkbox lg feature_item_lbl text-right text_descriptive">
                                    <input type="hidden" name="feature_item" value="0">
                                    <input id="feature_item" checked="checked" name="feature_item" type="checkbox" value="1">
                                    <!-- Feature Item -->
                                    Feature This Post*
                                    <span class="check-style">
                                        <em class="fa fa-check"></em>
                            ...
                            <span class="label-detail feature_price">(Only $19.95)</span>
                            <span class="label-detail feature_text">    
                                <p>- Increase Visibility Across Our Vast Network</p>
                                <p>- Maximize Probability to Find What You&#039;ve Lost</p>
                                <p>- Enhance Chance of Retrieving Your Lost Items</p>
                            </span>
                        </div>
                    </div>
                </div>
